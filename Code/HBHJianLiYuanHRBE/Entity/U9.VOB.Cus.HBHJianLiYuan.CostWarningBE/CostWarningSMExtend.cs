...
namespace U9.VOB.Cus.HBHJianLiYuan
{
    ...
    [Persistent]
    [Serializable]
    internal class ServiceOrderSubscriber_CostWarning : IEventSubscriber
    {
        ...
        public void Notify(params object[] args)
        {
            ...
            if (args.Length == 1)
            {
                ...
                {
                    CostWarning entity = this.EntityKey.GetEntity() as CostWarning;
