...
namespace ItemMasterRef
{
    public partial class ItemMasterRefWebPart
    {
		...
		private void ConfirmButton_Click_Extend(object sender, EventArgs  e)
		{
            ...
            table.Columns.Add("Supplier_ID", typeof(long));
            table.Columns.Add("Supplier_Code", typeof(string));
            ...
            foreach (cRefRecord record in this.Model.cRef.SelectRecords)
            {
                ...
                dr["Code"] = record.Code;
                dr["Name"] = record.Name;
                dr["Supplier_ID"] = record.PurchaseInfo_Supplier_ID;
                dr["Supplier_Code"] = record.PurchaseInfo_Supplier_Code;
                dr["Supplier_Name"] = record.PurchaseInfo_Supplier_Name;
                table.Rows.Add(dr);
            }
            this.CurrentState["ReturnDeptItemList"] = table;
