...
{
    public partial class DepartOrgUIFormWebPart
    {
		...
		private void BtnClose_Click_Extend(object sender, EventArgs  e)
		{
			...
			BtnClose_Click_DefaultImpl(sender,e);
				...
				//RcvClick157_Click...
		private void RcvClick157_Click_Extend(object sender, EventArgs  e)
		{
			//调用模版提供的默认实现.--默认实现可能会调用相应的Action.
			
		
			RcvClick157_Click_DefaultImpl(sender,e);
		}	
		 
				//ShipClick144_Click...
		private void ShipClick144_Click_Extend(object sender, EventArgs  e)
		{
			//调用模版提供的默认实现.--默认实现可能会调用相应的Action.
			
		
			ShipClick144_Click_DefaultImpl(sender,e);
		}
