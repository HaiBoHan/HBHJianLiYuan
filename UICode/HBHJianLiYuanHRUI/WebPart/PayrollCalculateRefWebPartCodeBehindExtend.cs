 ...
 ***********************************************************************************************/
namespace PayrollCalculateRef
{
    public partial class PayrollCalculateRefWebPart
    {
		...
		private void ConfirmButton_Click_Extend(object sender, EventArgs  e)
		{
            ...
            multiSel.Code_Field = this.Model.cRef.FieldSalarySolution_Code.Name;
            multiSel.Name_Field = this.Model.cRef.FieldSalarySolution_Name.Name;
            multiSel.IDCol_Field = this.Model.cRef.FieldSalarySolution_Description.Name;
