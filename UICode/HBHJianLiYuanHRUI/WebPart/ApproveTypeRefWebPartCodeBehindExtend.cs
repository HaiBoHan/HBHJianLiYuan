 ...
 ***********************************************************************************************/
namespace ApproveTypeRef
{
    public partial class ApproveTypeRefWebPart
    {
        ...
        {
            this.Model.cRef.CurrentFilter.OPath = string.Format("MD_Class_ID in (select cls.UID from UFIDA::UBF::MD::Business::Type cls where cls.FullName = '{0}') and Name not in ('{1}') ", "UFIDA.U9.Base.Doc.ConfirmTypeEnum", "InTimeComfirm");
        }
